...
describe('question repository', () => {
  ...
  describe('getQuestions', () => {
    ...
    it('should return an array of 2 questions', async () => {
      await initQuestionsMock() // <-- init for all tests
  ...
  describe('getQuestionById', () => {
    it('should return an targeted question', async () => {
      const { id } = questionsMock[0]
      expect(await questionRepo.getQuestionById(id)).toStrictEqual(
        questionsMock[0]
      )
    })
  ...
  describe('addQuestion', () => {
    ...
    it('should return a created question id', async () => {
      const { createdQuestionId } = await questionRepo.addQuestion(
        questionDtoMock
      )
  ...
  describe('getAnswers', () => {
    ...
    it('incorrect question id - should return an empty array', async () => {
      expect(await questionRepo.getAnswers('incorrectId')).toStrictEqual([])
    })
  ...
  describe('getAnswer', () => {
    ...
    it('should return an targeted answer', async () => {
